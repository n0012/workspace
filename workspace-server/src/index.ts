    ...
    'slides.createFromJson',
    {
      ...
      inputSchema: {
        ...
        theme: z
          ...
          .optional()
          .describe(
            'Named colour palette and font defaults. Defaults to "light" when omitted. "light" = clean neutral (same colors as Google but with Arial for cross-platform compatibility). "google" = official Google brand palette (Google Sans font, four brand accent colors: "blue" #4285F4, "red" #EA4335, "yellow" #FBBC05, "green" #34A853). Both themes use near-black #202124 headers, white backgrounds, and four-color brand bar. Color aliases in style fields ("primary", "surface", "text", "blue", "red", "yellow", "green", etc.) resolve to the active theme. font_family defaults to the theme font; pass "theme" to opt in explicitly.',
          ),
      },
    },
