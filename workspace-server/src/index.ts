    ...
    'slides.createFromJson',
    {
      ...
      inputSchema: {
        ...
        theme: z
          ...
          .optional()
          .describe(
            'Named colour palette and font defaults. Defaults to "light" when omitted. "light" = clean neutral (near-black headers, Google Blue 600 accent, Arial). "google" = official Google brand palette (near-black #202124 headers, Google Sans font, four brand accent colors: "blue" #4285F4, "red" #EA4335, "yellow" #FBBC05, "green" #34A853 — use all four across the deck for an authentic Google look). "dark" = dark background, blue accent, Arial. Color aliases in style fields ("primary", "surface", "text", "blue", "red", "yellow", "green", etc.) resolve to the active theme. font_family defaults to the theme font; pass "theme" to opt in explicitly.',
          ),
      },
    },
