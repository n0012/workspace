    ...
    'slides.createFromJson',
    {
      ...
      inputSchema: {
        ...
        slideJson: z
          .string()
          .describe(
            'JSON string of the slide blueprint. Use {"slides":[{"elements":[...],"speaker_notes":"Talk track..."},...]} for multiple slides or {"elements":[...]} for one slide. speaker_notes are written automatically by the server — no separate API call needed.',
          ),
        theme: z
